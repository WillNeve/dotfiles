# Generated by Powerlevel10k configuration wizard on 2024-11-05 at 23:18 GMT.
# Based on romkatv/powerlevel10k/config/p10k-pure.zsh, checksum 07533.
# Wizard options: nerdfont-v3 + powerline, large icons, pure, rprompt, 1 line, compact,
...
() {
  ...
  # Shorten dir to show just current folder
  ...
  precmd_functions+=(set_dir_prefix_icon)
