# Generated by Powerlevel10k configuration wizard on 2025-09-26 at 10:09 BST.
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_SUBSEGMENT_SEPARATOR='%F{#cad3f5}%B\u2571%b'
  # Separator between same-color segments on the right.
  typeset -g POWERLEVEL9K_RIGHT_SUBSEGMENT_SEPARATOR='%F{#cad3f5}%B\u2571%b'
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND='#b8c0e0'
  # Color of the anchor directory segments. Anchor segments are never shortened. The first
  # segment is always an anchor.
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND='#91d7e3'
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local       meta='%F{#6e738d}'  # grey foreground
      local      clean='%F{#a6da95}'   # green foreground
      ...
      local       meta='%F{#5b6078}'  # grey foreground
      local      clean='%F{#5b6078}'  # grey foreground
      local   modified='%F{#5b6078}'  # grey foreground
      local  untracked='%F{#5b6078}'  # grey foreground
      local conflicted='%F{#5b6078}'  # grey foreground
    fi
  ...
  typeset -g POWERLEVEL9K_VCS_LOADING_VISUAL_IDENTIFIER_COLOR='#5b6078'
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_FOREGROUND='#b8c0e0'
